...
def load_random_model() -> (Callable, tf.keras.Model, str, int):
    models = [
        ...
        [tf.keras.applications.efficientnet.preprocess_input,
         tf.keras.applications.EfficientNetB1, 'EfficientNetB1', 240],
        [tf.keras.applications.efficientnet.preprocess_input,
         tf.keras.applications.EfficientNetB2, 'EfficientNetB2', 260],
        [tf.keras.applications.efficientnet.preprocess_input,
         tf.keras.applications.EfficientNetB3, 'EfficientNetB3', 300],
        [tf.keras.applications.efficientnet.preprocess_input,
         tf.keras.applications.EfficientNetB4, 'EfficientNetB4', 380],
        [tf.keras.applications.efficientnet.preprocess_input,
         tf.keras.applications.EfficientNetB5, 'EfficientNetB5', 456],
        [tf.keras.applications.efficientnet.preprocess_input,
         tf.keras.applications.EfficientNetB6, 'EfficientNetB6', 528],
        [tf.keras.applications.efficientnet.preprocess_input,
