...
def load_random_model() -> (Callable, tf.keras.Model, str, int):
    models = [
        ...
        [tf.keras.applications.densenet.preprocess_input,
         tf.keras.applications.EfficientNetB0, 'EfficientNetB0', 600],
        [tf.keras.applications.densenet.preprocess_input,
         tf.keras.applications.EfficientNetB1, 'EfficientNetB1', 600],
        [tf.keras.applications.densenet.preprocess_input,
         tf.keras.applications.EfficientNetB2, 'EfficientNetB2', 600],
        [tf.keras.applications.densenet.preprocess_input,
         tf.keras.applications.EfficientNetB3, 'EfficientNetB3', 600],
        [tf.keras.applications.densenet.preprocess_input,
         tf.keras.applications.EfficientNetB4, 'EfficientNetB4', 600],
        [tf.keras.applications.densenet.preprocess_input,
         tf.keras.applications.EfficientNetB5, 'EfficientNetB5', 600],
        [tf.keras.applications.densenet.preprocess_input,
